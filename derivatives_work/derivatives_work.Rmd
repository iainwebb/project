...
To specify the posterior GP distribution, we need three further covariance matrices: $k(x, x)$, $k(x, x^*)$ and $k(x^*, x)$. 

The posterior distribution is derived using Equation (2.19) in @rasmussen06:
...
df1 <- expand.grid(x1=seq(-5, 5, 1), x2=seq(-5, 5, 1))
df1$vx1 <- with(df1, Df1_x1(x1, x2))
df1$vx2 <- with(df1, Df1_x2(x1, x2))
