...
```{r, figures-side, fig.show="hold", out.width="50%", fig.height=6.75, echo=F, fig.cap="Slope field and contour plot for the function $f(x) = \\sqrt{100 - x_1^2 - x_2^2}$", warning=F}
f1 <- expression(
  (100 - x1^2 - x2^2)^(1/2)
)
# D(f1, "x1")
...
The remaining six steps require the selection of another function (which we'll call $g(x)$) to compare to $f(x)$ from Step 1. First we'll look at choices for this second function which offer an acceptable match; initially one which is a perfect match.
...
Since we're matching $g(x)$ with $f(x)$, we have

$$
g(x) = \sqrt{100 - x_1^2 - x_2^2}
$$
...
```{r, fig.show="hold", out.width="50%", fig.height = 6.75, echo=F, fig.cap="Slope field and contour plot for the function $g(x) = \\sqrt{100 - x_1^2 - x_2^2}$", warning=F}
f2 <- expression(
  (100 - x1^2 - x2^2)^(1/2)
)
# D(f1, "x1")
...
```{r, fig.show="hold", out.width="40%", fig.height = 6, echo=F, fig.cap="Normalised slope fields for the functions $f(x) = \\sqrt{100 - x_1^2 - x_2^2}$ and $g(x) = \\sqrt{100 - x_1^2 - x_2^2}$.", warning=F}
library(grid)
arrow_scale <- 1
...
For functions $f(x)$ and $g(x)$, whose contours plots are reprinted in Figure 10 below, we get a number of \textbf{`r round(measure_1,2)`}. This is extremely close to 1, which is want we would expect, since the contours match exactly. The only reason this is not exactly 1 is that at $(0,0)$, the dot product involves a (in fact two) zero vectors.

```{r, fig.show="hold", out.width="50%", fig.height = 6.75, echo=F, fig.cap="Contour plots for the functions $f(x) = \\sqrt{100 - x_1^2 - x_2^2}$ and $g(x) = \\sqrt{100 - x_1^2 - x_2^2}$.", warning=F}
# Data
x <- -10:10
y <- -10:10
...
$g(x)$ now takes the form:

$$
g(x) = \sqrt{100 - (x_1-5)^2 - x_2^2}
$$
...
```{r, fig.show="hold", out.width="50%", fig.height = 6.75, echo=F, fig.cap="Slope field and contour plot for the function $g(x) = \\sqrt{100 - (x_1-5)^2 - x_2^2}$", warning=F}
f2 <- expression(
  (100 - x1^2 - x2^2)^(1/2)
)
# D(f1, "x1")
...
```{r, fig.show="hold", out.width="40%", fig.height = 6, echo=F, fig.cap="Normalised slope fields for the functions $f(x) = \\sqrt{100 - x_1^2 - x_2^2}$ and $g(x) = \\sqrt{100 - (x_1-5)^2 - x_2^2}$.", warning=F}
library(grid)
arrow_scale <- 1
ggplot(normal_vector_field_1, aes(x = x1, y = x2)) +
  geom_segment(aes(xend = x1+nvx1/arrow_scale, yend = x2+nvx2/arrow_scale),
...
For functions $f(x)$ and $g(x)$, whose contours plots are reprinted in Figure 13 below, we get a number of \textbf{`r round(measure_2,2)`}.

```{r, fig.show="hold", out.width="50%", fig.height = 6.75, echo=F, fig.cap="Contour plots for the functions $f(x) = \\sqrt{100 - x_1^2 - x_2^2}$ and $g(x) = \\sqrt{100 - (x_1-5)^2 - x_2^2}$.", warning=F}
# Data
x <- -10:10
y <- -10:10
z_f <- sqrt(100 - outer(x ^ 2, y ^ 2, "+"))
...
```{r, fig.show="hold", out.width="50%", fig.height = 6.75, echo=F, fig.cap="Slope field and contour plot for the function $g(x) = \\sqrt{100 - x_1^2 - (x_2-5)^2}$", warning=F}
f2 <- expression(
  (100 - x1^2 - x2^2)^(1/2)
)
# D(f1, "x1")
...
```{r, fig.show="hold", out.width="40%", fig.height = 6, echo=F, fig.cap="Normalised slope fields for the functions $f(x) = \\sqrt{100 - x_1^2 - x_2^2}$ and $g(x) = \\sqrt{100 - x_1^2 - (x_2-5)^2}$.", warning=F}
library(grid)
arrow_scale <- 1
ggplot(normal_vector_field_1, aes(x = x1, y = x2)) +
  geom_segment(aes(xend = x1+nvx1/arrow_scale, yend = x2+nvx2/arrow_scale),
...
For functions $f(x)$ and $g(x)$, whose contours plots are reprinted in Figure 16 below, we get a number of \textbf{`r round(measure_3,2)`}.

```{r, fig.show="hold", out.width="50%", fig.height = 6.75, echo=F, fig.cap="Contour plots for the functions $f(x) = \\sqrt{100 - x_1^2 - x_2^2}$ and $g(x) = \\sqrt{100 - x_1^2 - (x_2-5)^2}$.", warning=F}
# Data
x <- -10:10
y <- -10:10
z_f <- sqrt(100 - outer(x ^ 2, y ^ 2, "+"))
...
```{r, fig.show="hold", out.width="50%", fig.height = 6.75, echo=F, fig.cap="Slope field and contour plot for the function $g(x) = \\sqrt{100 - (x_1-5)^2 - (x_2-5)^2}$", warning=F}
f2 <- expression(
  (100 - x1^2 - x2^2)^(1/2)
)
# D(f1, "x1")
...
```{r, fig.show="hold", out.width="40%", fig.height = 6, echo=F, fig.cap="Normalised slope fields for the functions $f(x) = \\sqrt{100 - x_1^2 - x_2^2}$ and $g(x) = \\sqrt{100 - (x_1-5)^2 - (x_2-5)^2}$.", warning=F}
library(grid)
arrow_scale <- 1
ggplot(normal_vector_field_1, aes(x = x1, y = x2)) +
  geom_segment(aes(xend = x1+nvx1/arrow_scale, yend = x2+nvx2/arrow_scale),
...
For functions $f(x)$ and $g(x)$, whose contours plots are reprinted in Figure 19 below, we get a number of \textbf{`r round(measure_4,2)`}.

```{r, fig.show="hold", out.width="50%", fig.height = 6.75, echo=F, fig.cap="Contour plots for the functions $f(x) = \\sqrt{100 - x_1^2 - x_2^2}$ and $g(x) = \\sqrt{100 - (x_1-5)^2 - (x_2-5)^2}$.", warning=F}
# Data
x <- -10:10
y <- -10:10
z_f <- sqrt(100 - outer(x ^ 2, y ^ 2, "+"))
...
On the next page, side-by-side contour plots for each pair of $f(x)$ and $g(x)$ from Sections 3.1 and 3.2 are presented, along with their value of the alignment measure.
